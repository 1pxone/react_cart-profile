...
class CartIconSide extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isOpen: false
    ...
    render(){
        ...
        return (
            <OverlaySide isOpen={this.state.isOpen} onClose={()=>this.toggleDropdown()} align="right">
                <React.Fragment>
                ...
                <React.Fragment>
                    {this.props.cart.length ? (
                        <React.Fragment>
                            <div className="r-overlay__heading">
                            ...
                            {onCart ? null :
                                <div className="r-overlay__bottom">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CartIconSide));
